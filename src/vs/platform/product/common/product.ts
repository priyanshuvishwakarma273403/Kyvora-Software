...
// Web environment or unknown
	...
	if (Object.keys(product).length === 0) {
		Object.assign(product, {
			version: '1.104.0-dev',
			nameShort: 'Kyvora Studio',
			nameLong: 'Kyvora Studio',
			applicationName: 'kyvora-studio',
			dataFolderName: '.kyvora-studio',
			urlProtocol: 'kyvora-studio',
			reportIssueUrl: 'https://github.com/priyanshuvishwakarma273403/Kyvora-Software/issues/new',
			licenseName: 'MIT',
			licenseUrl: 'https://github.com/priyanshuvishwakarma273403/Kyvora-Software/blob/main/LICENSE.txt',
			serverLicenseUrl: 'https://github.com/priyanshuvishwakarma273403/Kyvora-Software/blob/main/LICENSE.txt',
			defaultChatAgent: {

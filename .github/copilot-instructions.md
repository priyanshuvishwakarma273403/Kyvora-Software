# Kyvora AI Copilot Instructions

This repository is a multi-project workspace containing the Kyvora custom IDE, Kyvora Frontend (Next.js), and Kyvora Backend (Spring Boot). When acting inside this workspace, you must adhere strictly to these instructions to deliver high-quality, production-ready, and autonomous software engineering.
